...
describe("html-literal", function () {
    it("should work as intended", function () { return __awaiter(_this, void 0, void 0, function () {
        var info, output;
        return __generator(this, function (_a) {
            ...
            output = index_1.default(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      <h1>HTML Tagged Template Literal</h1>\n      <p>Name: ", "</p>\n      <p>Age: ", "</p>\n      <p>Details: <pre>", "</pre></p>\n      <p>Weakness: ", "</p>\n      <p>Enemy: ", "</p>\n      <p>Interests: ", "</p>\n      <ul>\n        ", "\n      </ul>\n    "], ["\n      <h1>HTML Tagged Template Literal</h1>\n      <p>Name: ", "</p>\n      <p>Age: ", "</p>\n      <p>Details: <pre>", "</pre></p>\n      <p>Weakness: ", "</p>\n      <p>Enemy: ", "</p>\n      <p>Interests: ", "</p>\n      <ul>\n        ",
                "\n      </ul>\n    "])), info.name, info.age, info.details, info.weakness, info.enemy, info.getInterests(), info.jokes.map(function (joke) {
                return index_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n              <li>", "</li>\n            "], ["\n              <li>", "</li>\n            "])), joke);
            }));
